...
typewriter
  .pauseFor(1800)
  .changeDelay(20)
  .typeString("Moi c'est Bougouin Morgan")
  .pauseFor(300)
  .typeString("<strong>, Intégrateur web </strong> !")
  .pauseFor(1000)
  .deleteChars(1)
  .typeString('<span style="color: #E34C26;">HTML</span> !')
  .pauseFor(1000)
  .deleteChars(6)
  .typeString('<span style="color: #0084ff;">CSS</span> !')
  .pauseFor(1000)
  .deleteChars(5)
  .typeString('<span style="color: #c571a3;">SASS</span> !')
  .pauseFor(1000)
  .deleteChars(6)
  .typeString('<span style="color: #00b2f3;">Tailwind</span> !')
  .pauseFor(1000)
  .deleteChars(10)
  .typeString('<span style="color: #0ACF83;">Figma</span> !')
  .start();
